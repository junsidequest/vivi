...
export default function WalkingLoader({progress=null,error=false,theme='island',onModelReady}){
  ...
  return <div className={`walking-loader ${theme==='professional'?'walking-loader--professional':''} ${percent===null?'is-indeterminate':''} ${error?'has-error':''} ${percent===100?'is-complete':''}`}>
    <div className="walking-loader-content">
      <div className="walking-loader-stage">
        <div className="walking-loader-route" style={{'--progress':`${modelVisible?(percent??0):0}%`}}>
          <div className="walking-loader-avatar" ref={host} aria-hidden="true"/>
